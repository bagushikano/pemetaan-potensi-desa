                                            ...
                                            <div class="form-group">
                                                <div class="form-row">
                                                    <div class="col">
                                                        ...
                                                        <input type="text" class="form-control" name="nama_desa" id="nama_desa" placeholder="Ex: peguyangan" required>
                                                    </div>
                                                </div>
                                                <div class="form-row mt-3">
                                                    <div class="col">
                                                        <label for="koordinat">Data koordinat</label>
                                                        <input type="text-area" class="form-control" name="koordinat" id="koordinat" placeholder="" required readonly>
                                                    </div>
                                                </div>
                                            </div>
...
@push('anjay')
    ...
    <script>
        $(document).ready(function(){
            alertDone('Data desa berhasil di tambahkan')
        });
    </script>
    @endif
    ...
    @if((session('failed')))
        <script>
            $(document).ready(function(){
                alertFail('Data desa gagal di tambahkan')
            });
        </script>
    @endif
@endpush
