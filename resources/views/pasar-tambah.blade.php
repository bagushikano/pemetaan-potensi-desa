        ...
        @section('content')
            ...
            <div id="content">
                ...
                <div class="container-fluid mt-5">
                    <h1 class="h3 mb-2 text-gray-800">Tambah pasar</h1>
                    <!-- Content Row -->
                    <div class="row">
                        <!-- Area Chart -->
                        <div class="col-lg-8">
                        ...
                        <div class="col-lg-4">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div>
                                        <form method="POST" action="{{ route('pasar-store') }}">
                                            @csrf
                                            <div class="form-group">
                                                <div class="form-row">
                                                    <div class="col">
                                                        <label for="nama_pasar">Nama pasar</label>
                                                        <input type="text" class="form-control" name="nama_pasar" id="nama_pasar" placeholder="Ex: Pasar peguyangan" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row mt-3">
                                                    <div class="col">
                                                        ...
                                                        <input type="text" class="form-control" name="alamat_pasar" id="alamat_pasar" placeholder="Ex: Jalan astasura" required>
                                                    </div>
                                                </div>
                                                <div class="form-row mt-3">
                                                    <div class="col">
...
@push('anjay')
    ...
    <script>
        $(document).ready(function(){
            alertDone('Data pasar berhasil di tambahkan')
        });
    </script>
    @endif
    ...
    @if((session('failed')))
        <script>
            $(document).ready(function(){
                alertFail('Data pasar gagal di tambahkan')
            });
        </script>
    @endif
@endpush
