                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div>
                                        <form method="POST" action="{{ route('tempatibadah-store') }}">
                                            @csrf
                                            <div class="form-group">
                                                <div class="form-row">
                                                    <div class="col">
                                                        <label for="nama_tempat_ibadah">Nama tempat ibadah</label>
                                                        <input type="text" class="form-control" name="nama_tempat_ibadah" id="nama_tempat_ibadah" placeholder="Ex: Pura Desa" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row mt-3">
                                                    <div class="col">
                                                        ...
                                                        <input type="text" class="form-control" name="alamat_tempat_ibadah" id="alamat_tempat_ibadah" placeholder="Ex: Jalan astasura" required>
                                                    </div>
                                                </div>
                                                <div class="form-row mt-3">
                                                    <div class="col">
...
@push('anjay')
    ...
    <script>
        $(document).ready(function(){
            alertDone('Data tempat ibadah berhasil di tambahkan')
        });
    </script>
    @endif
    ...
    @if((session('failed')))
        <script>
            $(document).ready(function(){
                alertFail('Data tepmat ibadah gagal di tambahkan')
            });
        </script>
    @endif
@endpush
